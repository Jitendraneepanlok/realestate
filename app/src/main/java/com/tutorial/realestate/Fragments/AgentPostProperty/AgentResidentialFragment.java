...
import com.tutorial.realestate.Fragments.OwnerPostPropertyFragments.OwnerPropertyLocationFragment;
import com.tutorial.realestate.R;

public class AgentResidentialFragment extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_agent_residential_property,container,false);
        initView();
        return view;
    }
