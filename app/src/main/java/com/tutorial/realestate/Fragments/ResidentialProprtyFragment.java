...
public class ResidentialProprtyFragment extends Fragment {
    View view;
    ...
    ResidentialProprtyAdapter residentialProprtyAdapter;
    private List<Album> albumList;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_resideiantial, container, false);
    ...
    private void initView2() {
        ...
        residentialProprtyAdapter = new ResidentialProprtyAdapter(getActivity(), albumList);
        ...
        residential_recycler.setAdapter(residentialProprtyAdapter);
        prepareAlbums();
...
//                navController.navigate(R.id.action_residiantialpropertyFragment_to_propertyDetailsFragment);
    ...
    private void prepareAlbums() {
        ...
        residentialProprtyAdapter.notifyDataSetChanged();
    }
