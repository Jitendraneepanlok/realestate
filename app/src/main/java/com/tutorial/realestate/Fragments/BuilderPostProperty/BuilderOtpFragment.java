...
import com.tutorial.realestate.Fragments.OwnerPostPropertyFragments.OwnerPackageFragment;
import com.tutorial.realestate.Fragments.OwnerPostPropertyFragments.OwnerPropertyStatusFragment;
import com.tutorial.realestate.R;

public class BuilderOtpFragment extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_builder_otp, container, false);
        initView();
        return view;
    }
    ...
    private void initView() {
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /*OwnerPackageFragment ownerPackageFragment = new OwnerPackageFragment();
                androidx.fragment.app.FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                androidx.fragment.app.FragmentTransaction transaction = fragmentManager.beginTransaction();
                transaction.replace(R.id.post_propertyfragments, ownerPackageFragment);
                transaction.addToBackStack("Back");
                transaction.commit();*/
            }
        });
