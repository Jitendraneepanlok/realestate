...
public class StartContactDetailFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_start_contact_details, container, false);
        initView();
        return view;
    }
    ...
    private void initView() {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                StartVrifyOtpFragment startVrifyOtpFragment = new StartVrifyOtpFragment();
                androidx.fragment.app.FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                androidx.fragment.app.FragmentTransaction transaction = fragmentManager.beginTransaction();
                transaction.replace(R.id.start_frame_main, startVrifyOtpFragment);
                transaction.addToBackStack("Back");
                transaction.commit();
            }
        });
